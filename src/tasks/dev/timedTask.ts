async function timedTask(data: any, ctx: any) {
    console.log(
        `Hello i am a timed task from guild ${ctx.bot.guilds.cache.get(data.guildId)}`,
    );
}
...
module.exports = {
    data: {
        ...
        time: [
            ...
            "12:41",
            "12:42",
        ], // tod to activate it, format "HH:MM" (can be an array)
